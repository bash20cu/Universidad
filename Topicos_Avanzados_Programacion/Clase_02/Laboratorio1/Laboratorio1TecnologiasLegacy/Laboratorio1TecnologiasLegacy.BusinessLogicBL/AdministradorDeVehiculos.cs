//Clase administradora de vehiculos usando la clase Vehiculo de la capa Model.
//Se deben implementar las operaciones CRUD (Crear, Leer, Actualizar, Eliminar) 
...
namespace Laboratorio1TecnologiasLegacy.BusinessLogicBL
{
    public class AdministradorDeVehiculos
    {
        ...
        public void Agregar(Model.Vehiculo vehiculo)
        {
            ...
            if (vehiculos.Any(vehiculos => vehiculo.Id == vehiculo.Id))
            {
