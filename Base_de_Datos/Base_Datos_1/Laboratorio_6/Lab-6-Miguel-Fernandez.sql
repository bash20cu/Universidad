...
/* 1.	Seleccionar a todas las personas que viven en el c�digo electoral 10302023  */
...
/*
2.	Seleccionar la fecha de caducidad mayor y menor, en la misma instrucci�n, para ello debe investigar 
...
/*
3.	Seleccionar el nombre m�s extenso y el menos extenso. Usar la funci�n LEN. 
...
adem�s el apellido1 y el apellido2 empiece con una vocal y termine con una vocal.
...
/*
8.	Seleccionar los 15 primeros apellidos (apellido1) m�s comunes y 
...
/*
9.	Seleccionar los 10 c�digos electorales donde existen mayor 
poblaci�n inscrita para votar. 
*/
...
sin importar si tildan (Santamar�a) o Rodr�guez.
